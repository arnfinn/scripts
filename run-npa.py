...
parser.add_argument("--mpi", dest="mpi", default=80,
...
parser.add_argument("-d","--dalton", dest="dalton", default=home+"/dalton-openrsp/openrsp-npa/dalton",
...
time1 = time.time()
print "Calculating {0} excitation energies"
